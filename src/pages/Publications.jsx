      ...
      <div className="text-primaryGreen max-w-4xl mx-auto px-4 py-12">
        ...
        <ul className="mb-12 space-y-4 main-text">
          <li>
            ...
            <br />
            <a
              href="https://doi.org/10.1177/27541258231156847"
              className="text-primaryOrange hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://doi.org/10.1177/27541258231156847
            </a>
          </li>
          <li>
            ...
            <br />
            <a
              href="https://doi.org/10.1177/27541258231210202"
              className="text-primaryOrange hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://doi.org/10.1177/27541258231210202
            </a>
          </li>
          <li>
            <span className="font-bold">
          ...
          <li>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              https://doi.org/10.1177/1103308816644110
            </a>
          </li>
        </ul>
        ...
        <ul className="mb-12 space-y-4 main-text">
          <li>
            ...
            <br />
            <a
              href="https://doi.org/10.1007/978-3-030-55161-2"
              className="text-primaryOrange hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            ...
            <span className="italic">
              Producing and contesting urban marginality: interdisciplinary and
          ...
          <li>
            ...
            . Springer.
            <br />
            ISBN: 978-3-319-96112-5
            <br />
            <a
              href="https://doi.org/10.1007/978-3-319-96113-2_2"
              className="text-primaryOrange hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://doi.org/10.1007/978-3-319-96113-2_2
            </a>
          </li>
          <li>
            <span className="font-bold">
